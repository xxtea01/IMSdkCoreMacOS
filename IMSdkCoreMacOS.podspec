#
#  Be sure to run `pod spec lint IMSdkCoreMacOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Abxkafak" => "abxkafak@kformances.io" }
  ...
  spec.source       = { :git => "https://github.com/xxtea01/IMSdkCoreMacOS.git", :tag => "#{spec.version}" }
