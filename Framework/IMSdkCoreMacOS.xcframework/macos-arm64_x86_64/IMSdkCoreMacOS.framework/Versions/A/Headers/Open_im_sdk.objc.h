// Objective-C API for talking to github.com/xxtea01/im-sdk-core/v2/open_im_sdk Go package.
//   gobind -lang=objc github.com/xxtea01/im-sdk-core/v2/open_im_sdk
//
 ...
 */
FOUNDATION_EXPORT void Open_im_sdkAddUserCommand(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, int32_t typ, NSString* _Nullable uuid, NSString* _Nullable value);
 ...
 */
FOUNDATION_EXPORT void Open_im_sdkGetAllUserCommands(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, int32_t typ);
...
FOUNDATION_EXPORT void Open_im_sdkSearchMomentsNotification(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable searchParam);

FOUNDATION_EXPORT void Open_im_sdkSearchWallets(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable searchParam);
